export const translations: Record<string, any> = {
  SK: {
    ...
    formGdpr: "Súhlasím so spracovaním osobných údajov za účelom kontaktovania ohľadom projektu Zieger Mill.",
    formGdprLink: "Viac informácií",
  ...
  EN: {
    ...
    formGdpr: "I agree to the processing of my personal data for the purpose of being contacted about the Zieger Mill project.",
    formGdprLink: "More information",
  ...
  DE: {
    ...
    formGdpr: "Ich stimme der Verarbeitung meiner personenbezogenen Daten zu, um bezüglich des Projekts Zieger Mill kontaktiert zu werden.",
    formGdprLink: "Mehr Informationen",
    ...
    navContact: "Kontakt",
    stickyCtaLabel: "Ich habe Interesse",
  }
};
